    ...
    pub fn make_es(&mut self) -> () {
        ...
        match self.face {
            Tileset::Characters => {
                ...
                if self.red == true {
                    // 赤牌
                    color = "1;91;107".to_string(); // 太字・文字色明赤・背景色明白
                } else {
                    color = "1;30;107".to_string(); // 太字・文字色黒・背景色明白
                }
            }
            Tileset::Dots => {
                facechar = self.get_number();
                if self.red == true {
                    ...
                    color = "1;94;107".to_string(); // 太字・文字色明青・背景色明白
                }
            }
            Tileset::Bamboos => {
                facechar = self.get_number();
            ...
            Tileset::Dragons => {
                match &self.number {
                    ...
                    1 => {
                        ...
                        color = "1;32;107".to_string(); // 太字・文字色緑・背景色明白
                    }
                    2 => {
